...
<head>
    ...
    <title>PCBuilder - Tambah Produk</title>
...
<div class="max-w-2xl mx-auto mt-8 px-4 pb-16">
    ...
    <form method="POST" action="{{ route('seller.components.store') }}" enctype="multipart/form-data"
        ...
        <div>
            ...
            <input type="text" name="name" value="{{ old('name') }}"
                   ...
                   placeholder="cth: Intel Core i5-12400F">
        ...
        <div>
            ...
            <textarea name="description" rows="4"
                      class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                      placeholder="Spesifikasi lengkap produk...">{{ old('description') }}</textarea>
        </div>
